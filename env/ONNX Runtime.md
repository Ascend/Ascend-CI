...
update-alternatives --install /usr/bin/cmake cmake /root/toolset/cmake/bin/cmake 100
update-alternatives --install /usr/bin/ctest ctest /root/toolset/cmake/bin/ctest 100
```
...
// Follow [安装CANN](https://ascend.github.io/docs/sources/ascend/quick_install.html)
